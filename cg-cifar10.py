...
# print("args.gtarget=", args.gtarget)
# exit()
...
save_folder = os.path.join(common.EXPS_PATH, 'save_CIFAR10_model')
#########################
...
def load_cifar10():
    ...
    trainset = torchvision.datasets.CIFAR10(root=common.CIFAR10_PATH, train=True,
                                            download=True, transform=transform_train)
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size,
                                              shuffle=True, num_workers=4, pin_memory=True)

    testset = torchvision.datasets.CIFAR10(root=common.CIFAR10_PATH, train=False,
