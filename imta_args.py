...
data_group.add_argument('--data', metavar='D', default='cifar10',
                        choices=['cifar10', 'cifar100', 'ImageNet','dummy','actnet'],  # TODO(yue)
...
optim_group.add_argument('--lr-type', default='multistep', type=str, metavar='T',
                        ...
                        choices=['cosine', 'multistep', 'piecewise'])  # TODO(yue)
...
# TODO(yue)
arg_parser.add_argument('--num_segments', type=int, default=16)
arg_parser.add_argument('--imagenet_pretrained',  action='store_true')
arg_parser.add_argument('--lr_steps', nargs='+', type=int, default=None)
arg_parser.add_argument('--lrs', nargs='+', type=float, default=None)