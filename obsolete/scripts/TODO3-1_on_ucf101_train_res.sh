...
python main_base.py ucf101 RGB --arch resnet50 --num_segments 16 --lr 0.02 --epochs 10 --batch-size 72 -j 36 --npb --rescale_to 224 --folder_suffix _self --exp_header ucf_res50_e10_224_0 --gpus 0 1 2 3 4 5 --with_test

# exp-1 resnet34, t=16, size 168, batchsize 72, train 10 epochs
python main_base.py ucf101 RGB --arch resnet34 --num_segments 16 --lr 0.02 --epochs 10 --batch-size 72 -j 36 --npb --rescale_to 168 --folder_suffix _self --exp_header ucf_res34_e10_168_0 --gpus 0 1 2 3 4 5 --with_test

# exp-2 resnet18, t=16, size 112, batchsize 72, train 10 epochs
python main_base.py ucf101 RGB --arch resnet18 --num_segments 16 --lr 0.02 --epochs 10 --batch-size 72 -j 36 --npb --rescale_to 112 --folder_suffix _self --exp_header ucf_res18_e10_112_0 --gpus 0 1 2 3 4 5 --with_test

# exp-3 resnet50, t=16, size 224, batchsize 48, train 50 epochs
python main_base.py ucf101 RGB --arch resnet50 --num_segments 16 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 36 --npb --rescale_to 224 --folder_suffix _self --exp_header ucf_res50_s224_e50_b48 --gpus 0 1 2 3 4 5 --with_test

# exp-4 lstm, resnet50, t=16, size 224, batchsize 48, train 50 epochs
python main_base.py ucf101 RGB --arch resnet50 --num_segments 16 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 36 --npb --folder_suffix _self --ada_reso_skip  --policy_backbone resnet50 --offline_lstm_all --exp_header ucf_res50_s224_e50_b48_lstm_all --gpus 0 1 2 3 4 5 --with_test

# TODO(phase 1) Baselines and Joint
# exp-5 joint
python main_base.py ucf101 RGB --arch resnet50 --num_segments 16 --lr 0.001 --epochs 50 --lr_steps 50 100 --batch-size 36 -j 48 --npb --folder_suffix _self --ada_reso_skip --policy_backbone mobilenet_v2 --reso_list 224 168 112 84 --backbone_list resnet50 resnet34 resnet18 --skip_list 1 2 4 --policy_also_backbone --policy_input_offset 3 --model_paths ucf_res50_e10_224_0/m.pth.tar ucf_res34_e10_168_0/m.pth.tar ucf_res18_e10_112_0/m.pth.tar --accuracy_weight 0.97 --efficency_weight 0.03 --uniform_loss_weight 3.0  --use_gflops_loss --exp_decay --init_tau 5 --exp_header ucf_res_3m124_a.97e.03_ed5_ft10ds_lr.001_gu3 --gpus 0 1 2 3 4 5 --with_test
