...
python main_base_bak.py actnet RGB --arch res3d50 --num_segments 8 --lr 0.02 --epochs 10 --batch-size 72 -j 12 --npb --gpus 0 1 2 3 --exp_header act_t8_res3d50_sz224_b72_e10 --folder_suffix _self --cnn3d --seg_len 8 --rescale_to 224 --pretrain imagenet

#TODO 1. train basemodel res3d34 on 168*168 for 10 epochs
python main_base_bak.py actnet RGB --arch res3d34 --num_segments 8 --lr 0.02 --epochs 10 --batch-size 72 -j 12 --npb --gpus 0 1 2 3 --exp_header act_t8_res3d34_sz168_b72_e10 --folder_suffix _self --cnn3d --seg_len 8 --rescale_to 168 --pretrain imagenet

#TODO 2. train basemodel res3d18 on 112*112 for 10 epochs
python main_base_bak.py actnet RGB --arch res3d18 --num_segments 8 --lr 0.02 --epochs 10 --batch-size 72 -j 12 --npb --gpus 0 1 2 3 --exp_header act_t8_res3d18_sz112_b72_e10 --folder_suffix _self --cnn3d --seg_len 8 --rescale_to 112 --pretrain imagenet

#TODO 3. train basemodel res3d34 on 168*168 for 50 epochs
python main_base_bak.py actnet RGB --arch res3d34 --num_segments 40 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header act_t40_res3d34_sz168_b48_e50 --folder_suffix _self --cnn3d --seg_len 8 --rescale_to 168 --pretrain imagenet
