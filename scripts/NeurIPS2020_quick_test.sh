#TODO this is for quicktest
#TODO first check the path settings in <project_dir>/common.py and <project_dir>/common_<your name>.py
#TODO as an alternative, you can set --data_path and --exp_path manually everytime in command line
