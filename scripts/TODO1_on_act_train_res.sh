...
python main.py actnet RGB --arch resnet50 --num_segments 16 --lr 0.02 --epochs 10 --batch-size 72 -j 36 --npb --rescale_to 224 --folder_suffix _self --exp_header actnet_resnet50_t16_s224_e10_b72 --gpus 0 1 2 3 --with_test

# exp-1 resnet34, size 168, batchsize 72, train 10 epochs
python main.py actnet RGB --arch resnet34 --num_segments 16 --lr 0.02 --epochs 10 --batch-size 72 -j 36 --npb --rescale_to 168 --folder_suffix _self --exp_header actnet_resnet34_t16_s168_e10_b72 --gpus 0 1 2 3 --with_test

# exp-2 resnet18, size 112, batchsize 72, train 10 epochs
python main.py actnet RGB --arch resnet18 --num_segments 16 --lr 0.02 --epochs 10 --batch-size 72 -j 36 --npb --rescale_to 112 --folder_suffix _self --exp_header actnet_resnet18_t16_s112_e10_b72 --gpus 0 1 2 3 --with_test

# exp-3 resnet50, size 224, batchsize 48, train 50 epochs
python main.py actnet RGB --arch resnet50 --num_segments 16 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 36 --npb --rescale_to 224 --folder_suffix _self --exp_header actnet_resnet50_t16_s224_e50_b48 --gpus 0 1 2 3 --with_test

# exp-4 lstm, resnet50, size 224, batchsize 48, train 50 epochs
python main.py actnet RGB --arch resnet50 --num_segments 16 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 36 --npb --folder_suffix _self --ada_reso_skip  --policy_backbone resnet50 --offline_lstm_all --exp_header actnet_resnet50_t16_s224_e50_b48_lstm_all --gpus 0 1 2 3 --with_test
