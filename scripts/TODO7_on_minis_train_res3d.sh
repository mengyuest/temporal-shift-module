...
python main.py MINISTH RGB --arch res3d34 --num_segments 40 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_res3d34_sz168_b48_e50 --folder_suffix _self --cnn3d --seg_len 8 --rescale_to 168 --pretrain imagenet
...
python main.py MINISTH RGB --arch res3d34 --num_segments 40 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_res3d34_sz168_b48_e50_lstm_all --folder_suffix _self --cnn3d --seg_len 8 --pretrain imagenet --ada_reso_skip --policy_backbone res3d34 --reso_list 168 --offline_lstm_all
...
python main.py MINISTH RGB --arch res3d34 --num_segments 40 --lr 0.001 --epochs 50 --lr_steps 50 100 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_2m124_a.9e.1_ed5_ft10ds_lr.001_gu3_debug --ada_reso_skip --policy_backbone mobilenet3dv2 --reso_list 168 112 84 --backbone_list res3d34 res3d18 --skip_list 1 2 4 --accuracy_weight 0.9 --efficency_weight 0.1 --folder_suffix _self --exp_decay --init_tau 5 --policy_also_backbone --policy_input_offset 2 --uniform_loss_weight 3.0 --use_gflops_loss --cnn3d --seg_len 8 --model_paths R34/imta_models/ckpt.best.pth R18/imta_models/ckpt.best.pth

#TODO 6. train rand policy
python main.py MINISTH RGB --arch res3d34 --num_segments 40 --lr 0.001 --epochs 50 --lr_steps 50 100 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_2m124_a.9e.1_ed5_ft10ds_lr.001_gu3_rand_debug --ada_reso_skip --policy_backbone mobilenet3dv2 --reso_list 168 112 84 --backbone_list res3d34 res3d18 --skip_list 1 2 4 --accuracy_weight 0.9 --efficency_weight 0.1 --folder_suffix _self --exp_decay --init_tau 5 --policy_also_backbone --policy_input_offset 2 --uniform_loss_weight 3.0 --use_gflops_loss --cnn3d --seg_len 8 --random_policy --model_paths R34/imta_models/ckpt.best.pth R18/imta_models/ckpt.best.pth

#TODO 7. train all policy
python main.py MINISTH RGB --arch res3d34 --num_segments 40 --lr 0.001 --epochs 50 --lr_steps 50 100 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_2m124_a.9e.1_ed5_ft10ds_lr.001_gu3_all_debug --ada_reso_skip --policy_backbone mobilenet3dv2 --reso_list 168 112 84 --backbone_list res3d34 res3d18 --skip_list 1 2 4 --accuracy_weight 0.9 --efficency_weight 0.1 --folder_suffix _self --exp_decay --init_tau 5 --policy_also_backbone --policy_input_offset 2 --uniform_loss_weight 3.0 --use_gflops_loss --cnn3d --seg_len 8 --all_policy --model_paths R34/imta_models/ckpt.best.pth R18/imta_models/ckpt.best.pth

#TODO 8. scsampler
python main.py MINISTH RGB --arch res3d34 --num_segments 40 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 12 --npb --folder_suffix _self  --ada_reso_skip --policy_backbone mobilenet3dv2 --backbone_list res3d34 --reso_list 168 84 --policy_input_offset 1 --model_paths R34/imta_models/ckpt.best.pth.tar --frame_independent --real_scsampler --consensus_type scsampler --freeze_backbone --cnn3d --seg_len 8 --with_test --exp_header ms2_t40c5_res3d34_scs_ac_fd_k3_b48 --gpus 0 1 2 3  --top_k 3
