...
#TODO 8. scsampler
python main.py ucf101 RGB --arch res3d34 --num_segments 40 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 48 -j 12 --npb  --ada_reso_skip --policy_backbone mobilenet3dv2 --backbone_list res3d34 --reso_list 168 84 --policy_input_offset 1 --model_paths R34_E50/imta_models/ckpt.best.pth.tar --frame_independent --real_scsampler --consensus_type scsampler --freeze_backbone --cnn3d --seg_len 8 --with_test --exp_header ucf_t40c5_res3d34_scs_ac_fd_k3_b48 --gpus 0 1 2 3  --top_k 3
