...
python main.py MINISTH RGB --arch res3d50 --num_segments 40 --lr 0.02 --epochs 50 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_res3d50_sz224_b48_e50_debug --folder_suffix _self --cnn3d --seg_len 8 --rescale_to 224 --pretrain imagenet

#TODO 5. train basemodel res3d50 , lstm on 224*224 for 50 epochs
python main.py MINISTH RGB --arch res3d50 --num_segments 40 --lr 0.02 --epochs 50 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_res3d50_sz224_b48_e50_lstm_all --folder_suffix _self --cnn3d --seg_len 8 --pretrain imagenet --ada_reso_skip --policy_backbone res3d50 --reso_list 224 --offline_lstm_all


#TODO PHASE-II
#TODO 6. joint training adaptive policy
python main.py MINISTH RGB --arch res3d50 --num_segments 40 --lr 0.001 --epochs 50 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_3m124_a.9e.1_ed5_ft10ds_lr.001_gu3_debug --ada_reso_skip --policy_backbone mobilenet3dv2 --reso_list 224 168 112 84 --backbone_list res3d50 res3d34 res3d18 --skip_list 1 2 4 --accuracy_weight 0.9 --efficency_weight 0.1 --folder_suffix _self --exp_decay --init_tau 5 --policy_also_backbone --policy_input_offset 3 --uniform_loss_weight 3.0 --use_gflops_loss --cnn3d --seg_len 8 --model_paths R50/models/ckpt.best.pth R34/models/ckpt.best.pth R18/models/ckpt.best.pth

#TODO 7. train rand policy
python main.py MINISTH RGB --arch res3d50 --num_segments 40 --lr 0.001 --epochs 50 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_3m124_a.9e.1_ed5_ft10ds_lr.001_gu3_rand_debug --ada_reso_skip --policy_backbone mobilenet3dv2 --reso_list 224 168 112 84 --backbone_list res3d50 res3d34 res3d18 --skip_list 1 2 4 --accuracy_weight 0.9 --efficency_weight 0.1 --folder_suffix _self --exp_decay --init_tau 5 --policy_also_backbone --policy_input_offset 3 --uniform_loss_weight 3.0 --use_gflops_loss --cnn3d --seg_len 8 --random_policy --model_paths R50/models/ckpt.best.pth R34/models/ckpt.best.pth R18/models/ckpt.best.pth

#TODO 8. train all policy
python main.py MINISTH RGB --arch res3d50 --num_segments 40 --lr 0.001 --epochs 50 --batch-size 48 -j 12 --npb --gpus 0 1 2 3 --exp_header ms2_t40_3m124_a.9e.1_ed5_ft10ds_lr.001_gu3_all_debug --ada_reso_skip --policy_backbone mobilenet3dv2 --reso_list 224 168 112 84 --backbone_list res3d50 res3d34 res3d18 --skip_list 1 2 4 --accuracy_weight 0.9 --efficency_weight 0.1 --folder_suffix _self --exp_decay --init_tau 5 --policy_also_backbone --policy_input_offset 3 --uniform_loss_weight 3.0 --use_gflops_loss --cnn3d --seg_len 8 --all_policy --model_paths R50/models/ckpt.best.pth R34/models/ckpt.best.pth R18/models/ckpt.best.pth
