...
#TODO 10 epo
#TODO(done)
python main_base.py actnet RGB --arch dmynet50 --num_segments 16 --lr 0.02 --epochs 10 --lr_steps 20 40 --npb --folder_suffix _self --rescale_to 224 --dmy --num_filters_list 64 48 32 --default_signal 0 --batch-size 48 -j 72 --gpus 0 1 2 3 --exp_header act_dres3_chain0_224_0_e10_b48_lcs --last_conv_same

#TODO 50 epo
#TODO(done)
python main_base.py actnet RGB --arch dmynet50 --num_segments 16 --lr 0.02 --epochs 50 --lr_steps 20 40 --npb --folder_suffix _self --rescale_to 224 --dmy --num_filters_list 64 48 32 --default_signal 0 --batch-size 48 -j 72 --gpus 0 1 2 3 --exp_header act_dres3_chain0_224_0_e50_b48_lcs --last_conv_same
...
#TODO 10 epo
#TODO(done)
python main_base.py actnet RGB --arch dmynet50 --num_segments 16 --lr 0.02 --epochs 10 --lr_steps 20 40 --npb --folder_suffix _self --rescale_to 224 --dmy --num_filters_list 64 32 16 --default_signal 0 --batch-size 48 -j 72 --gpus 0 1 2 3 --exp_header act_d631_chain0_224_0_e10_b48
