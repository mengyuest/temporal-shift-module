...
python main.py actnet RGB --arch ir_csn_50 --num_segments 16 --lr 0.02 --epochs 50 --lr_steps 20 40 --batch-size 5 -j 36 --npb --rescale_to 224 --folder_suffix _self --exp_header actnet_ircsn50_t16_s224_e50_b48_debug --gpus 0 --cnn3d --csn