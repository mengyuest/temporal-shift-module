...
NUM_THREADS = 100
VIDEO_ROOT = '/store/datasets/something/v2/20bn-something-something-v2'         # Downloaded webm videos
FRAME_ROOT = '/store/datasets/something/v2/20bn-something-something-v2-frames'  # Directory for extracted frames
